      ...
      <Dialog open={openCreateModal} onClose={handleCloseCreateModal}>
        ...
        <DialogContent>
          ...
          <TextField
            ...
            type="text"
            fullWidth
            value={newTransaction.applicationNo}
            onChange={(e) => setNewTransaction({ ...newTransaction, applicationNo: e.target.value })}
          />
          ...
          {transactionToEdit && (
            <>
              ...
              <TextField
                ...
                type="number"
                fullWidth
                value={transactionToEdit.lotSize}
                onChange={(e) =>
                  setTransactionToEdit({
                    ...transactionToEdit,
              ...
              <TextField
                ...
                type="date"
                fullWidth
                value={transactionToEdit.appliedDate}
                onChange={(e) =>
                  setTransactionToEdit({
                    ...transactionToEdit,
              ...
              <FormControl fullWidth sx={{ margin: "0.5rem 0" }}>
                ...
                <Select
                  label="Granted By"
                  value={transactionToEdit.grantedBy._id}
                  onChange={(e) =>
                    setTransactionToEdit({
                      ...transactionToEdit,
                      grantedBy: users.find((user) => user._id === e.target.value),
                    })
                  }
                  fullWidth
                >
              ...
              <Stack direction="row" alignItems="center" spacing={2}>
                Is Own
                <Switch
                  checked={transactionToEdit.is_own}
                  onChange={(e) =>
                    setTransactionToEdit({
                      ...transactionToEdit,
              ...
              <Stack direction="row" alignItems="center" spacing={2}>
                Is Alloted
                <Switch
                  checked={transactionToEdit.is_alloted}
                  onChange={(e) =>
                    setTransactionToEdit({
                      ...transactionToEdit,
                      is_alloted: e.target.checked,
                    })
                  }
                  inputProps={{ 'aria-label': 'controlled' }}
                />
