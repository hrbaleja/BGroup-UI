...
export function addPDFHeader(doc) {
    ...
    const taglineText = 'Your Tagline Space';
    ...
    contactItems.forEach((item) => {
        ...
        doc.link(currentX, itemY, textWidths, 2, { url: item.link });
        currentX += textWidths + 10;
    });
...
// And Date and this things then No extc in bwlow line