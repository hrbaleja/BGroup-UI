...
import { Stack, Dialog, Button, Switch, TextField, DialogTitle, DialogContent, DialogActions, } from '@mui/material';

import companyService from 'src/services/company/companyService';

export default function NewCompany({ open, onClose, fetchCompanies }) {
